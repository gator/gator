...
export default function Page() {
  return (
    <main className='min-h-screen px-5 lg:px-60'>
      <h1 className='text-2xl lg:text-3xl text-center lg:text-left'>
        Privacy Policy
      </h1>
      <h2 className='text-center lg:text-left text-xs lg:text-sm text-[#9CC2A0] mb-10 lg:mb-20'>
      ...
      <p className='my-2'>
        ...
        types of information that is collected and recorded by Gator and how we
        use it.
      </p>
      ...
      <p className='my-2'>
        Note that Gator has no access to or control over these cookies that are
