...
const PrivacyPolicy: NextPageWithLayout = () => {
  return (
    <>
      ...
      >
        <h1 className='mt-40 text-5xl font-bold'>Privacy Policy</h1>
        <p className='mt-4 mb-40'>Last updated June 01, 2023</p>

        <p className='my-2'>
          At Gator, accessible from https://gator.sh, one of our main priorities
          is the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by Gator and how
          we use it.
        </p>
        ...
        <p className='my-2'>
          ...
          shared and/or collect in Gator. This policy is not applicable to any
          information collected offline or via channels other than this website.
        </p>

        <h2 className='mt-10 text-lg font-bold'>Consent</h2>
        ...
        <h2 className='mt-10 text-lg font-bold'>Information we collect</h2>
        ...
        <h2 className='mt-10 text-lg font-bold'>How we use your information</h2>
        ...
        <p className='my-2'>
          Like any other website, Gator uses "cookies". These cookies are used
        ...
        <p className='my-2'>
          Note that Gator has no access to or control over these cookies that
        ...
        <h2 className='mt-10 text-lg font-bold'>GDPR Data Protection Rights</h2>
        ...
        <p className='my-2'>
          Gator does not knowingly collect any Personal Identifiable Information
        ...
        <h2 className='mt-10 text-lg font-bold'>Contact Us</h2>
