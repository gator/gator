    ...
    <>
      ...
      >
        <section>
          ...
          <p className='my-2'>
            At Gator, accessible from https://gator.sh, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by Gator and how we use it.
          </p>
          ...
          <p className='my-2'>
            ...
            that they shared and/or collect in Gator. This policy is not
          ...
          <p className='my-2'>
            Gator follows a standard procedure of using log files. These files
          ...
          <p className='my-2'>
            ...
            respective advertisements and links that appear on Gator, which are
          ...
          <p className='my-2'>
            Gator does not knowingly collect any Personal Identifiable
