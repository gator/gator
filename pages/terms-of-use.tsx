...
const TermsOfUse: NextPageWithLayout = () => {
  return (
    <>
      ...
      >
        <section>
          <h1 className='mt-40 text-5xl font-bold'>Terms of Use</h1>
          <p className='mt-4 mb-40'>Last updated June 01, 2023</p>

          <p className='my-2'>Welcome to Gator!</p>

          <p className='my-2'>
            These terms and conditions outline the rules and regulations for the
            use of Gator, LLC's Website, located at https://gator.sh.
          </p>

          <p className='my-2'>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Gator if you do not agree to take
          ...
          <p className='my-2'>
            ...
            intellectual property rights for all material on Gator. All
            intellectual property rights are reserved. You may access this from
            Gator for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p className='my-2'>You must not:</p>
          <ul className='ml-4 list-inside'>
            <li className='list-disc'>Republish material from Gator.</li>
            <li className='list-disc'>
              Sell, rent or sub-license material from Gator.
            </li>
            <li className='list-disc'>
              Reproduce, duplicate or copy material from Gator.
            </li>
            <li className='list-disc'>Redistribute content from Gator.</li>
          </ul>
          ...
          <p className='my-2'>
            ...
            Gator, LLC does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Gator, LLC,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Gator, LLC
          ...
          <p className='my-2'>
            Gator, LLC reserves the right to monitor all Comments and to remove
          ...
          <p className='my-2'>
            You hereby grant Gator, LLC a non-exclusive license to use,
          ...
          <ul className='ml-4 list-inside'>
            ...
            <li className='list-disc'>Accounting, law and consulting firms.</li>
            <li className='list-disc'>
          ...
          <p className='my-2'>
            ...
            visibility of the hyperlink compensates the absence of Gator, LLC;
          ...
          <p className='my-2'>
            ...
            sending an e-mail to Gator, LLC. Please include your name, your
          ...
          <ul className='ml-4 list-inside'>
            <li className='list-disc'>By use of our corporate name.</li>
            <li className='list-disc'>
          ...
          <p className='my-2'>
            No use of Gator, LLC's logo or other artwork will be allowed for
          ...
          <h3 className='mt-10 text-lg font-bold'>Content Liability</h3>
          ...
          <h3 className='mt-10 text-lg font-bold'>Reservation of Rights</h3>
          ...
          <h3 className='mt-10 text-lg font-bold'>Disclaimer</h3>
